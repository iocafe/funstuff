...
module walls(width=650, length=700, wall_thickness=15, wall_height=260,wall_color=[255/255, 255/255, 255/255],wall_alpha=1.0)
{
    // Colors
    ...
    translate([sliding_door_2_x_pos, 
        -width/2+wall_thickness/2,
        wall_height/2 - sliding_door_y_pos])
    frontdoor(sliding_door_width, sliding_door_height, wall_thickness); 
