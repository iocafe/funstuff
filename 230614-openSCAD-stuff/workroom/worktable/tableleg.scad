...
module tableleg(height = 73.9, width = 56, bar_diam = 3.8, dimensions=true, explode=false)
{
    d = explode ? 20 : 0;
    ...
    tl_anglebar(height, bar_diam, c1, straight1=true);
    translate([0,width+d,0]) 
    rotate([0,0,180])
    tl_anglebar(height, bar_diam, c1, straight2=true);
    translate([d,0,0]) 
    rotate([0,0,90])
    tl_anglebar(width, bar_diam, c2);
    ...
    tl_anglebar(len, bar_diam, c2, straight1=true, straight2=true);
    ...
    rotate([0,0,180])
    tl_anglebar(len2, bar_diam, c2, straight1=true, straight2=true);
    ...
    translate([0,bar_diam/2,0]) 
     rotate([0,0,180])
    tl_anglebar(len2+0.5,bar_diam, c2,straight1=true, straight2=true);
    }
}        

module tl_anglebar(height, bar_diam, c, straight1=false, straight2=false)
{
   color(c)
    {
